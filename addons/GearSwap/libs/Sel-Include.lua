...
function default_aftercast(spell, spellMap, eventArgs)
	if spell.interrupted then
		if spell and spell.type:contains('Magic') or spell.type == 'Ninjutsu' or spell.type == 'BardSong' then
...
function get_idle_set(petStatus)
	...
	--ckm Added quite possibly breaking other sets
	if moving and sets.moving then
		idleSet = set_combine(idleSet, sets.moving)
	end

	if state.IdleMode.value == 'Normal' and not moving then 
