...
function init_gear_sets()
    ...
    sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		...
		back="Perimede Cape",waist="Witful Belt",legs=vanya_slops,feet="Regal Pumps +1"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})
	
    sets.precast.FC.Stoneskin = set_combine(sets.precast.FC['Enhancing Magic'], {})

    sets.precast.FC['Healing Magic'] = set_combine(sets.precast.FC, {legs="Assiduity Pants"})
	...
	sets.midcast.Cure = {main="Queller Rod",sub="Sors Shield",ammo="Pemphredo Tathlum",
		...
		back="Alaunus's Cape",waist="Luminary Sash",legs=vanya_slops,feet="Kaykaus Boots"}
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
		...
		back="Moonlight Cape",waist="Flax Sash",legs="Assiduity Pants",feet=gear.chironic_refresh_feet}
	...
	sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
		...
		back="Umbra Cape",waist="Witful Belt",legs="Assiduity Pants",feet=gear.chironic_refresh_feet}
...
local vanya_slops = { name="Vanya Slops", augments={'MP+50','"Cure" potency +7%','Enmity-6',}}