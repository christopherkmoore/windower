...
function init_gear_sets()
	...
	sets.precast.Step = {ammo="Falcon Eye",
		...
		back="Segomo's Mantle",waist="Moonbow Belt",legs="Hiza. Hizayoroi +2",feet="Malignance Boots"}
		
	sets.precast.Flourish1 = {ammo="Falcon Eye",
		head="Malignance Chapeau",neck="Sanctity Necklace",ear1="Mache Earring +1",ear2="Telos Earring",
		body="Malignance Tabard",hands="Hesychast's Gloves +1",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
		back="Segomo's Mantle",waist="Moonbow Belt",legs="Mummu Kecks +2",feet="Malignance Boots"}
	...
	sets.precast.WS = {ammo="Voluspa Tathlum",
		...
		body="Adhemar Jacket +1",hands="Adhemar Wrist. +1",ring1="Niqmaddu Ring",ring2="Petrov Ring",
		back=gear.cape_TP_MNK,waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet=gear.herculean_ta_feet}

	sets.precast.WSSomeAcc = {ammo="Falcon Eye",head="Malignance Chapeau",legs="Hiza. Hizayoroi +2"}
	sets.precast.WSAcc = {ammo="Falcon Eye",head="Malignance Chapeau",neck="Combatant's Torque",ear1="Cessance Earring",ring2="Ramuh Ring +1",body="Malignance Tabard",waist="Moonbow Belt",legs="Hiza. Hizayoroi +2",feet="Malignance Boots"}
	sets.precast.WSFullAcc = {ammo="Falcon Eye",head="Mummu Bonnet +2",neck="Sanctity Necklace",ear1="Mache Earring +1",ear2="Telos Earring",body="Malignance Tabard",hands="Ryuo Tekko",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",waist="Moonbow Belt",legs="Hiza. Hizayoroi +2",feet="Malignance Boots"}
	...
	sets.precast.WS['Cataclysm'] = {ammo="Dosis Tathlum",
		...
		back=gear.cape_TP_MNK,legs="Nahtirah Trousers"}
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		head="Malignance Chapeau",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Sanare Earring",
	...
	sets.idle.PDT = {ammo="Staunch Tathlum +1",
		head="Genmei Kabuto",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Sanare Earring",
	...
	sets.defense.PDT = {ammo="Staunch Tathlum +1",
		head="Genmei Kabuto",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Sanare Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back="Moonlight Cape",waist="Moonbow Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum +1",
		...
		back="Moonlight Cape",waist="Flax Sash",legs="Malignance Tights",feet="Hippo. Socks +1"}
	...
	sets.defense.MEVA = {ammo="Staunch Tathlum +1",
		...
		back="Toro Cape",waist="Flax Sash",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.engaged.PDT = {ammo="Aurgelmir Orb +1",
		head="Genmei Kabuto",neck="Loricate Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back="Moonlight Cape",waist="Moonbow Belt",legs="Malignance Tights",feet="Hippo. Socks +1"}
