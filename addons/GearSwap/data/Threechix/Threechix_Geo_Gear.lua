...
function init_gear_sets()
	...
	sets.midcast.Geomancy = {main="Solstice",sub="Genmei Shield",range="Dunna",
		head="Azimuth Hood",neck="Bagua Charm +1",ear1="Gna Earring",ear2="Fulla Earring",           -- neck="Incanter's Torque" ,ear1="Gifted Earring",ear2="Malignance Earring",  
		body="Bagua Tunic +1",hands="Geo. Mitaines +1",ring1="Defending Ring",ring2="Dark Ring",
		back="Solemnity Cape",waist="Austerity Belt",legs="Bagua Pants +1",feet="Azimuth Gaiters"}
	...
	sets.idle = {main="Malignance Pole",ammo="Staunch Tathlum +1",
		head="Mallquis Chapeau +1",neck="Dampener's torque",ear1="Genmei Earring",ear2="Moonshade Earring",
	...
	sets.idle.Pet = {main="Sucellus",sub="Genmei Shield",range="Dunna",
		head="Azimuth Hood",neck="Dampener's torque",ear1="Handler's Earring",ear2="Handler's Earring +1",
	...
	sets.idle.Weak = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		...
		back="Umbra Cape",waist="Flax Sash",legs="Assid. Pants +1",feet="Azimuth Gaiters"}
	...
	sets.HPDown = {head="Pixie Hairpin +1",ear1="Mendicant's Earring",ear2="Evans Earring",
		body="Mallquis saio +2",hands="Jhakri Cuffs +2",ring1="Mephitas's Ring +1",ring2="Mephitas's Ring",
