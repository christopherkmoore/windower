...
function init_gear_sets()
	...
	sets.midcast.Geomancy = {main="Solstice",sub="Genmei Shield",range="Dunna",
		...
		body="Vedic Coat",hands="Geo. Mitaines +1",ring1="Defending Ring",ring2="Dark Ring",
	...
	sets.idle = {main="Malignance Pole",ammo="Staunch Tathlum +1",
		head="Mallquis Chapeau +1",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Moonshade Earring",
