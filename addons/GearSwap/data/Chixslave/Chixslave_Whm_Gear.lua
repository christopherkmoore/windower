...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Ababinili +1",sub="Clerisy Strap +1",ammo="Impatiens",
		...
		back=gear.cape_idle,waist="Embla Sash",legs="Ebers Pantaloons +2",feet="Regal Pumps +1"}
    ...
    sets.MagicBurst = {main="Daybreak", sub="Enki Strap",neck="Mizu. Kubikazari",head="Ebers Cap +2", hands="Ebers mitts +2",legs="Ebers Pantaloons +2", ear1="Malignance Earring", 
	...
	sets.midcast.Cure = {main="Queller Rod" ,sub="Sors Shield",ammo="Pemphredo Tathlum",
		...
		back=gear.cape_cure,waist="Luminary Sash",legs="Ebers Pantaloons +2",feet=gear.vanya_clogs_CURE}
	...
	sets.midcast.LightWeatherCure = {main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
		...
		back=gear.cape_cure,waist="Hachirin-no-Obi",legs="Ebers Pantaloons +2",feet=gear.vanya_clogs_CURE}
	...
	sets.midcast.Cure.DT = {main="Queller Rod",sub="Sors Shield",ammo="Staunch Tathlum +1",
		...
		back=gear.cape_cure,waist="Luminary Sash",legs="Ebers Pantaloons +2",feet="Gende. Galosh. +1"}
	...
	sets.midcast.Cursna = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		...
		back="Alaunus's Cape",waist="Witful Belt",legs="Theophany Pantaloons +2",feet=gear.vanya_clogs_CURE}
	...
	sets.midcast.StatusRemoval = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		...
		back="Swith Cape +1",waist="Witful Belt",legs="Ebers Pantaloons +2",feet="Regal Pumps +1"}
	...
	sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {head = "Inyanga Tiara +2", hands="Ebers Mitts +2",legs="Theophany Pantaloons +2",})
	...
	sets.midcast['Divine Magic'] = {main="Marin Staff +1",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=gear.cape_Holy,waist="Luminary Sash",legs="Theophany Pantaloons +2",feet="Ebers Duckbills +2"}
	...
	sets.midcast.Holy = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		back=gear.cape_Holy,waist=gear.ElementalObi,legs="Theophany Pantaloons +2",feet="Ebers Duckbills +2"}
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		back="Aurist's Cape +1",waist="Luminary Sash",legs="Chironic Hose",feet="Theophany duckbills +2"}
	...
	sets.idle.PDT = {main="Queller Rod",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		...
		back=gear.cape_idle,waist="Flax Sash",legs="Ebers Pantaloons +2",feet="Ebers Duckbills +2"}
	...
	sets.idle.Weak = {main="Queller Rod",sub="Genmei Shield",ammo="Homiliary",
		...
		back=gear.cape_idle,waist="Witful Belt",legs="Ebers Pantaloons +2",feet="Ebers Duckbills +2"}
	...
	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		...
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Defending Ring",ring2="Inyang Ring",
		back=gear.cape_idle,waist="Flax Sash",legs="Theophany Pantaloons +2",feet="Ebers Duckbills +2"}
    ...
    sets.engaged = {ammo="Staunch Tathlum +1",
        ...
        back=gear.cape_idle,waist="Windbuffet Belt +1",legs="Ebers Pantaloons +2",feet="Ebers Duckbills +2"}

    sets.engaged.Acc = {ammo="Hasty Pinion +1",
        head="Ebers Cap +2",neck="Combatant's Torque",ear1="Telos Earring",ear2="Brutal Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back=gear.cape_idle,waist="Olseni Belt",legs="Ebers Pantaloons +2",feet="Ebers Duckbills +2"}

	sets.engaged.DW = {ammo="Staunch Tathlum +1",
        head="Ebers Cap +2",neck="Asperity Necklace",ear1="Telos Earring",ear2="Suppanomimi",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back=gear.cape_idle,waist="Shetal Stone",legs="Ebers Pantaloons +2",feet="Ebers Duckbills +2"}
	...
	sets.HPCure = {main="Queller Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		back="Alaunus's Cape",waist="Eschan Stone",legs="Ebers Pantaloons +2",feet=gear.vanya_clogs_CURE}
