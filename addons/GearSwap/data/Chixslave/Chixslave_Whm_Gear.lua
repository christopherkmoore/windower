...
function init_gear_sets()
	...
	-- 	body="Ebers Bliaut +2 +2",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Lebeche Ring",
    ...
    sets.precast.FC = {main="Ababinili +1",sub="Clerisy Strap +1",ammo="Impatiens",
		...
		body="Ebers Bliaut +2",hands="Gende. Gages +1",ring1="Kishar Ring", ring2="Weatherspoon Ring",                                           -- ring2="Lebeche Ring",
		back=gear.cape_idle,waist="Embla Sash",legs="Ebers Pant. +2",feet="Regal Pumps +1"}
    ...
    sets.precast.WS = {ammo="Hasty Pinion +1",
		head="Ebers Cap +2",neck="Asperity Necklace",ear1="Moonshade Earring",ear2="Brutal Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Buquwik Cape",waist="Fotia Belt",legs="Assid. Pants +1",feet="Gende. Galosh. +1"}
		
    sets.precast.WS.Dagan = {ammo="Hasty Pinion +1",
		head="Ebers Cap +2",neck="Asperity Necklace",ear1="Etiolation Earring",ear2="Moonshade Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Buquwik Cape",waist="Fotia Belt",legs="Assid. Pants +1",feet="Gende. Galosh. +1"}
	...
	sets.ConserveMP = {main=gear.grioavolr_fc_staff,sub="Umbra Strap",ammo="Hasty Pinion +1",
		head=gear.vanya_hood,neck="Incanter's Torque",ear1="Gifted Earring",ear2="Gwati Earring",
		body="Vedic Coat",hands="Fanatic Gloves",ring1="Kishar Ring",ring2="Prolix Ring",
		back="Solemnity Cape",waist="Austerity Belt +1",legs="Vanya Slops",feet=gear.chironic_conserveMP}
		
	sets.midcast.Teleport = sets.ConserveMP
	
	-- Gear for Magic Burst mode.
    sets.MagicBurst = {main="Daybreak", sub="Enki Strap",neck="Mizu. Kubikazari",head="Ebers Cap +2", hands="Ebers mitts +2",legs="Ebers Pant. +2", ear1="Malignance Earring", 
	ring1="Weatherspoon Ring",ring2="Locus Ring"}
	
    sets.midcast.FastRecast = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Hasty Pinion +1",
		head="Ebers Cap +2",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body="Ebers Bliaut +2",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Prolix Ring",
	...
	sets.midcast.Cure = {main="Queller Rod" ,sub="Sors Shield",ammo="Pemphredo Tathlum",
		head="Ebers Cap +2",neck="Incanter's Torque",ear1="Regal Earring",ear2="Glorious Earring",
		body="Ebers Bliaut +2",hands="Theophany Mitts +2",ring1="Janniston Ring",ring2="Menelaus's Ring",
		back=gear.cape_cure,waist="Luminary Sash",legs="Ebers Pant. +2",feet=gear.vanya_clogs_CURE}
	...
	sets.midcast.LightWeatherCure = {main="Chatoyant Staff",sub="Curatio Grip",ammo="Esper Stone +1",
		head="Ebers Cap +2",neck="Incanter's Torque",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Ebers Bliaut +2",hands="Theophany Mitts +2",ring1="Janniston Ring",ring2="Lebeche Ring",
		back=gear.cape_cure,waist="Hachirin-no-Obi",legs="Ebers Pant. +2",feet=gear.vanya_clogs_CURE}
	...
	sets.midcast.Cure.DT = {main="Queller Rod",sub="Sors Shield",ammo="Staunch Tathlum +1",
		head="Ebers Cap +2",neck="Loricate Torque +1",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		body="Ayanmo Corazza +2",hands="Gende. Gages +1",ring1="Defending Ring",ring2="Dark Ring",
		back=gear.cape_cure,waist="Luminary Sash",legs="Ebers Pant. +2",feet="Gende. Galosh. +1"}
		
	--Melee Curesets are used whenever your Weapons state is set to anything but None.
	sets.midcast.MeleeCure = {ammo="Pemphredo Tathlum",
		head="Ebers Cap +2",neck="Incanter's Torque",ear1="Regal Earring",ear2="Glorious Earring",
		body="Ebers Bliaut +2",hands="Kaykaus Cuffs",ring1="Janniston Ring",ring2="Lebeche Ring",
		back=gear.cape_cure,waist="Luminary Sash",legs="Ebers Pant. +2",feet=gear.vanya_clogs_CURE}
	...
	sets.midcast.Cursna = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		...
		body="Ebers Bliaut +2",hands="Inyan. Dastanas +2",ring1="Haoma's Ring",ring2="Menelaus's Ring",
		back="Alaunus's Cape",waist="Witful Belt",legs="Th. Pantaloons +2",feet=gear.vanya_clogs_CURE}

	sets.midcast.StatusRemoval = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		head="Ebers Cap +2",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body="Ebers Bliaut +2",hands="Fanatic Gloves",ring1="Kishar Ring",ring2="Prolix Ring",
		back="Swith Cape +1",waist="Witful Belt",legs="Ebers Pant. +2",feet="Regal Pumps +1"}
	...
	sets.midcast['Enhancing Magic'] = {main=gear.gada_enhancing_club,sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		...
		body="Telchine Chas.",hands="Inyan. Dastanas +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Perimede Cape",waist="Embla Sash",legs="Telchine Braconi",feet="Ebers Duckbills +2"}
	...
	sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {head = "Inyanga Tiara +2", hands="Ebers Mitts +2",legs="Th. Pantaloons +2",})
	...
	sets.midcast.BarElement = {main="Beneficus",sub="Ammurapi Shield",ammo="Staunch Tathlum +1",
		head="Ebers Cap +2",neck="Incanter's Torque",ear1="Andoaa Earring",ear2="Gifted Earring",
		body="Ebers Bliaut +2",hands="Ebers Mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=gear.cape_idle,waist="Embla Sash",legs="Piety Pantaln. +1",feet="Ebers Duckbills +1"}

	sets.midcast.Impact = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head=empty,neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Twilight Cloak",hands="Ebers mitts +2",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back="Toro Cape",waist="Acuity Belt +1",legs="Chironic Hose",feet=gear.chironic_conserveMP}
	...
	sets.midcast['Elemental Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Dosis Tathlum",
		...
		body="Witching Robe",hands="Ebers mitts +2",ring1="Shiva Ring +1",ring2="Freke Ring",
		back="Toro Cape",waist=gear.ElementalObi,legs="Chironic Hose",feet=gear.chironic_conserveMP}
	...
	sets.midcast['Elemental Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Dosis Tathlum",
		...
		body="Witching Robe",hands="Ebers mitts +2",ring1="Metamor. Ring +1",ring2="Freke Ring",
		back="Toro Cape",waist="Yamabuki-no-Obi",legs="Chironic Hose",feet=gear.chironic_conserveMP}

	sets.midcast['Divine Magic'] = {main="Marin Staff +1",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Ebers Cap +2",neck="Incanter's Torque",ear1="Regal Earring",ear2="Digni. Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back=gear.cape_Holy,waist="Luminary Sash",legs="Th. Pantaloons +2",feet="Ebers Duckbills +2"}
		
	sets.midcast.Holy = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Ebers Cap +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Metamor. Ring +1",ring2="Freke Ring",
		back=gear.cape_Holy,waist=gear.ElementalObi,legs="Th. Pantaloons +2",feet="Ebers Duckbills +2"}

	sets.midcast['Dark Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Ebers Cap +2",neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
    ...
    sets.midcast.Drain = {main="Rubicundity",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Evanescence Ring",ring2="Archon Ring",
    ...
    sets.midcast.Drain.Resistant = {main="Rubicundity",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        body="Chironic Doublet",hands="Ebers mitts +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back="Aurist's Cape +1",waist="Fucho-no-obi",legs="Chironic Hose",feet=gear.chironic_nuke_feet}
	...
	sets.midcast.Stun = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Hasty Pinion +1",
		head="Nahtirah Hat",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body="Ebers Bliaut +2",hands="Inyan. Dastanas +2",ring1="Kishar Ring",ring2="Stikini Ring +1",
	...
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Ebers Bliaut +2",hands="Fanatic Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Aurist's Cape +1",waist="Acuity Belt +1",legs="Chironic Hose",feet=gear.chironic_nuke_feet}
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Ebers Cap +2",neck="Erra Pendant",ear1="Malignance Earring",ear2="Nourish. Earring +1",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Inyanga Ring",ring2="Weatherspoon Ring",
		back=gear.cape_Holy,waist="Luminary Sash",legs="Ebers Pant. +2",feet="Theo. Duckbills +2"}
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		head="Befouled Crown",neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Theophany Briault +2",hands="Ebers mitts +2",ring1="Metamor. Ring +1",ring2="Weatherspoon Ring",
		back=gear.cape_Holy,waist="Luminary Sash",legs="Chironic Hose",feet="Theo. Duckbills +2"}
	...
	sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",ammo="Homiliary",
		...
		body="Ebers Bliaut +2",hands=gear.chironic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
		back=gear.cape_idle,waist="Fucho-no-obi",legs="Assid. Pants +1",feet="Ebers Duckbills +2"}
	...
	sets.idle.PDT = {main="Queller Rod",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Ebers Cap +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Vrikodara Jupon",hands="Ebers mitts +2",ring1="Defending Ring",ring2="Dark Ring",
		back=gear.cape_idle,waist="Flax Sash",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}
		
	sets.idle.MDT = {main="Queller Rod",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Ebers Cap +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Defending Ring",ring2="Inyang Ring",
		back=gear.cape_idle,waist="Flax Sash",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}
		
	sets.idle.Weak = {main="Queller Rod",sub="Genmei Shield",ammo="Homiliary",
		head="Ebers Cap +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Witching Robe",hands="Ebers mitts +2",ring1="Defending Ring",ring2="Dark Ring",
		back=gear.cape_idle,waist="Witful Belt",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}
	...
	sets.defense.PDT = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Ebers Cap +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Vrikodara Jupon",hands="Ebers mitts +2",ring1="Defending Ring",ring2="Dark Ring",
		back=gear.cape_idle,waist="Flax Sash",legs="Assid. Pants +1",feet="Ebers Duckbills +2"}

	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Ebers Cap +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Sanare Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Defending Ring",ring2="Inyang Ring",
		back=gear.cape_idle,waist="Flax Sash",legs="Th. Pantaloons +2",feet="Ebers Duckbills +2"}

    sets.defense.MEVA = {ammo="Staunch Tathlum +1",
        head="Ebers Cap +2",neck="Warder's Charm +1",ear1="Etiolation Earring",ear2="Sanare Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Vengeful Ring",Ring2="Purity Ring",
        back=gear.cape_idle,waist="Luminary Sash",legs="Telchine Braconi",feet="Ebers Duckbills +2"}
    ...
    sets.engaged = {ammo="Staunch Tathlum +1",
        head="Ebers Cap +2",neck="Asperity Necklace",ear1="Cessance Earring",ear2="Brutal Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back=gear.cape_idle,waist="Windbuffet Belt +1",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}

    sets.engaged.Acc = {ammo="Hasty Pinion +1",
        head="Ebers Cap +2",neck="Combatant's Torque",ear1="Telos Earring",ear2="Brutal Earring",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back=gear.cape_idle,waist="Olseni Belt",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}

	sets.engaged.DW = {ammo="Staunch Tathlum +1",
        head="Ebers Cap +2",neck="Asperity Necklace",ear1="Telos Earring",ear2="Suppanomimi",
		body="Ebers Bliaut +2",hands="Ebers mitts +2",ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back=gear.cape_idle,waist="Shetal Stone",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}

    sets.engaged.DW.Acc = {ammo="Hasty Pinion +1",
        head="Aya. Zucchetto +2",neck="Combatant's Torque",ear1="Telos Earring",ear2="Suppanomimi",
		body="Ayanmo Corazza +2",hands="Ebers mitts +2",ring1="Petrov Ring",Ring2="Ilabrat Ring",
        back=gear.cape_idle,waist="Shetal Stone",legs="Ebers Pant. +2",feet="Ebers Duckbills +2"}
	...
	sets.HPCure = {main="Queller Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Ebers Bliaut +2",hands="Kaykaus Cuffs",ring1="Kunaji Ring",ring2="Meridian Ring",
		back="Alaunus's Cape",waist="Eschan Stone",legs="Ebers Pant. +2",feet=gear.vanya_clogs_CURE}

	sets.buff.Doom = set_combine(sets.buff.Doom, {})

	sets.moving = { feet="Herald's Gaiters" }
